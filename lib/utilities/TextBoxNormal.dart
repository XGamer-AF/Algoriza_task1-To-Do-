  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          widget.title ?? '',
          style: OwnColors.suitableBlackBold(widget.lang),
        ),
        SizedBox(
          height: space1,
        ),
        TextFormField(
          ...
          style: OwnColors.normalGrayBold(widget.lang),
          decoration: InputDecoration(
              ...
              fillColor: OwnColors.colorPalette['lightGray'],
              filled: true,
              ...
              //   borderSide: BorderSide(
              //       width: 1.0,
              //       color: OwnColors.colorPalette['primary']!),
              // ),
              ...
              hintStyle: OwnColors.normalGrayBold(widget.lang)),
